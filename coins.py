...
def add_coins(remaining, total, results):
    """
    This will return all permutations of change making, and will be called by
    coins(), which will insure uniqueness
    """
    ...
    add_coins((remaining - 1), total + 10, results)
    add_coins((remaining - 1), total + 1, results)
...
def coins(num_coins):
    ...
    add_coins(remaining=num_coins, total=0, results=results)
